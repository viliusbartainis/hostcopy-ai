    ...
    <main className="min-h-screen bg-stone-50">
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Why most Airbnb descriptions fail</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">The structure that actually works</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Why one description doesn&apos;t work for three platforms</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Quick checklist before you publish</h2>
