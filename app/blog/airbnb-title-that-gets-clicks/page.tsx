    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">The formula: property type, one differentiator, location cue</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Words that quietly hurt your title</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Three before-and-after examples</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Match the title to who you actually want booking</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Revisit it every season</h2>
