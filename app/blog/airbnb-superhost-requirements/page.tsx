    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">The four core requirements</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">How often it&apos;s checked</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">What the badge actually gets you</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">How hosts usually lose it</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Is it worth chasing?</h2>
