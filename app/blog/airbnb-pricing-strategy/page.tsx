...
export default function BlogPost() {
  const jsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://hostcopy-ai.vercel.app/blog/airbnb-pricing-strategy",
    },
  };
    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Start with seasonality, not a guess</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Weekends vs. weekdays</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Competitor analysis, done properly</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Minimum stay as a pricing lever</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">When to raise or lower your price</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Common beginner mistakes</h2>
