    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Why long lists get skipped</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">What actually needs to be in the listing rules</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Explain the reason, not just the rule</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Put logistics somewhere else entirely</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">A reasonable starting set</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Enforcing rules without damaging the relationship</h2>
