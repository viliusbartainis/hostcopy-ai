    ...
    <main className="min-h-screen bg-background">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-display font-semibold text-stone-900 pt-4">What to actually post</h2>
          ...
          <h2 className="text-xl font-display font-semibold text-stone-900 pt-4">A caption formula that works for vacation rentals</h2>
          ...
          <h2 className="text-xl font-display font-semibold text-stone-900 pt-4">Hashtags: mix broad, local, and niche</h2>
