...
export default function BlogPost() {
  const jsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://hostcopy-ai.vercel.app/blog/airbnb-vs-booking-vs-vrbo",
    },
  };
    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Airbnb: the experience-driven audience</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Booking.com: the fact-checking, international audience</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Vrbo: families and longer whole-home stays</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">When it&apos;s worth listing on more than one platform</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Why the same description shouldn&apos;t go on all three</h2>
