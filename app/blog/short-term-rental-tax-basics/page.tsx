    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">This is general information, not tax advice</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">What most hosts need to declare</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Expenses that are commonly deductible, in general terms</h2>
