...
export default function BlogPost() {
  const jsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://hostcopy-ai.vercel.app/blog/airbnb-startup-cost",
    },
  };
    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Initial investment: furnishing and setup</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Recurring costs that eat into revenue</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Realistic profit examples by city size</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">When the investment actually pays off</h2>
