    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">A real workspace, not just a WiFi checkbox</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">WiFi speed, tested and stated, not assumed</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Self check-in: closer to an expectation than a bonus now</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Small details that bring guests back and get named in reviews</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">What to skip: amenities that cost more than they return</h2>
