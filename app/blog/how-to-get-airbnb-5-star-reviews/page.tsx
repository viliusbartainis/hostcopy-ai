    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">The check-in experience sets the tone for everything after</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Communication before, during, and after the stay</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Small surprises that actually get mentioned</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">When and how to ask for a review</h2>
