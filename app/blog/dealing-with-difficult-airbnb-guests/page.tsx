    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Keep the tone calm and factual, even when the guest isn&apos;t</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">When to escalate to Airbnb Support</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Documenting problems properly</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Boundaries worth setting before problems start</h2>
