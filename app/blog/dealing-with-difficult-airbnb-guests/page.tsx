    ...
    <main className="min-h-screen bg-background">
      ...
      <article id="main-content" className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <p>A reservation request that doesn&apos;t match the stated purpose &mdash; a large group booking a small listing while claiming only two people will stay &mdash; is worth a direct clarifying message before you confirm. A guest&apos;s past reviews showing a pattern of property damage or rule violations are worth weighing carefully even under <Link href="/blog/airbnb-hosting-glossary#instant-book" className="underline">Instant Book</Link>. Airbnb does allow host-initiated cancellations for genuine safety concerns without the usual penalty when properly documented, but repeated cancellations still hurt your <Link href="/blog/airbnb-hosting-glossary#superhost" className="underline">Superhost</Link> status, so this is a tool to use sparingly and only when it&apos;s genuinely warranted.</p>
