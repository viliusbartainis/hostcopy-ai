    ...
    <main className="min-h-screen bg-background">
      ...
      <article id="main-content" className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <p><Link href="/blog/airbnb-hosting-glossary#response-rate" className="underline">Response rate</Link> and response time carry real weight &mdash; replying within an hour, and always within 24, signals a host who won&apos;t leave a guest hanging mid-trip. <Link href="/blog/airbnb-hosting-glossary#instant-book" className="underline">Instant Book</Link> listings get a meaningful ranking boost, especially in last-minute searches, since Airbnb wants to show guests stays they can actually confirm right away. Acceptance rate matters too: declining a lot of requests works against you, so blocking dates you don&apos;t want booked is usually better than declining a live request. Cancellation rate on the host side is weighted heavily against you, and <Link href="/blog/airbnb-hosting-glossary#occupancy-rate" className="underline">occupancy rate</Link> at your current price point feeds in as well &mdash; Airbnb&apos;s ranking is ultimately optimizing for listings that convert into completed stays, not just listings that get looked at.</p>
