...
export default function BlogPost() {
  const jsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://hostcopy-ai.vercel.app/blog/airbnb-photography-tips",
    },
  };
    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-5">
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Natural light beats flash, almost always</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Angles that make a small room look worth booking</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">What kills a listing&apos;s photos</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">How many photos is actually enough</h2>
          ...
          <h2 className="text-xl font-serif font-semibold text-stone-900 pt-4">Phone or professional photographer?</h2>
